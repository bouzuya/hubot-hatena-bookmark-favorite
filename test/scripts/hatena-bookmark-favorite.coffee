...
describe 'hello', ->
  ...
  describe 'listeners[0].regex', ->
    describe 'valid patterns', ->
      beforeEach ->
        @tests = [
          message: '@hubot hatena-bookmark-favorite bouzuya'
          matches: ['@hubot hatena-bookmark-favorite bouzuya', 'bouzuya']
        ,
          message: '@hubot hateb-fav bouzuya'
          matches: ['@hubot hateb-fav bouzuya', 'bouzuya']
        ]
  ...
  describe 'robot.helpCommands()', ->
    it 'should be ["hubot hatena-bookmark-favorite <user> - show user\'s favorite"]', ->
